    ...
    <Section className="pt-[12rem] -mt-[5.25]"
          ...
          id="hero">
            ...
            <div className="container relative">
                <div className="relative z-1 max-w-[62rem] mx-auto text-center md-[4rem] md:mb-20 lg:mb:[6rem]"> 
                  ...
                  <div className="relative max-w-[23rem] mx-auto">
                      <div className="relative z-1 p-0.5 rounded-r-2xl bg-conic-gradient">
